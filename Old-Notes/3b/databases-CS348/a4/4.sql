...
-- Question: 4
-- Approach: join the enrollment table with itself and then grouped by the
--      original data so that the difference of the student's mark to the
--      average can be computed
--      use a where statement to filter based on the initial mark is greater
--      than 98
-- Assumptions: for the purposes of an average, a class is determined by its cno
--      and term so the average of a class is across all sections when being
--      subtracted from the student's mark


select enrollment.sno, enrollment.cno,
    enrollment.mark -  ROUND(AVG(enrol2.mark), 2) as DIFF
    from enrollment
    left join enrollment enrol2
    on enrollment.cno = enrol2.cno and enrollment.term = enrol2.term

    where enrollment.mark > 98

    group by enrollment.cno, enrollment.term
...
20591079    PHYS420     15.67
20591079    PHYS451     19.13
...
28580040    CS458       21.1
28638811    PHYS474     17.37
28921899    PHYS414     13.8
29017604    PHYS455     16.7
29050897    MATH395     17.21
29067979    MATH399     16.06
29119934    CS240       10.75
29171697    MATH197     15.0
29466896    CS312       17.75
29501010    PHYS368     18.57
29507951    MATH452     16.19
29615296    PHYS317     20.0
29643474    CS211       16.14
29808557    PHYS254     19.04
29877646    CS230       13.0
*/
